...
namespace lebrun.formularios.complementos
{
    public partial class frmConsultaArticulos : Form
    {
        ...
        private static frmConsultaArticulos m_FormDefInstance;
        ...
        public static frmConsultaArticulos DefInstance
        {
            get
            {
                if (m_FormDefInstance == null || m_FormDefInstance.IsDisposed)
                    m_FormDefInstance = new frmConsultaArticulos();
